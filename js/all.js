...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","<НЕ ЗАБЫТЬ : Имя раздела>","<НЕ ЗАБЫТЬ : Имя раздела>","<НЕ ЗАБЫТЬ : Имя раздела>","1. Первый раздел","2. Второй раздел","Раздел без номера","<НЕ ЗАБЫТЬ : Имя раздела>","1.1. Первый подраздел"],
    DREX_NODE_LINKS: ["index.htm","_ne_zabyt___imya_razdela__1.htm","_ne_zabyt___imya_razdela__2.htm","_ne_zabyt___imya_razdela__4.htm","pervyj_razdel.htm","vtoroj_razdel.htm","razdel_bez_nomera.htm","_ne_zabyt___imya_razdela__3.htm","pervyj_podrazdel.htm"],
    DREX_NODE_CHILD_START: [1,7,7,8,8,9,9,9,9],
    DREX_NODE_CHILD_END: [7,7,8,8,9,9,9,9,9],
    DREX_MENU_TYPE: 1,
